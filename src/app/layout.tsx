...
export const metadata: Metadata = {
  title: "LudoEarn - বাংলাদেশের সেরা লুডো আর্নিং প্ল্যাটফর্ম | Play & Earn Ludo",
  ...
  keywords: ["Ludo Earn", "Ludo King Tournament", "Ludo Tournament Bangladesh", "Online Ludo Earn", "বিকাশ লুডো গেম"],
  icons: {
    icon: "/logo.png",
    shortcut: "/logo.png",
    apple: "/logo.png",
